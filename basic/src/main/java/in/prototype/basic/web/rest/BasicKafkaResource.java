...
@RestController
@RequestMapping("/api/basic-kafka")
public class BasicKafkaResource {

    private final Logger log = LoggerFactory.getLogger(BasicKafkaResource.class);
    ...
    public BasicKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
