...
import pom.rest.error.types.TitleAlreadyExistsException;
...
public class ExceptionTranslator implements ProblemHandling {
  ...
  private String applicationName = "exception.demo";
  ...
  public ResponseEntity<Problem> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
    ...
    Problem problem = Problem.builder().withType(ErrorConstants.CONSTRAINT_VIOLATION_TYPE)
        ...
        .with(MESSAGE_KEY, ErrorConstants.ERR_VALIDATION).with(FIELD_ERRORS_KEY, fieldErrors)
        .build();
  ...
  public ResponseEntity<Problem> handleBadRequestAlertException(BadRequestAlertException ex,
      NativeWebRequest request) {
    return create(ex, request, HeaderUtil.createFailureAlert(applicationName, false,
   ...
   */
  @ExceptionHandler
  public ResponseEntity<Problem> handleTitleAlreadyUsedException(TitleAlreadyExistsException ex,
      NativeWebRequest request) {
    OpeningRegistrationException problem = new OpeningRegistrationException();
