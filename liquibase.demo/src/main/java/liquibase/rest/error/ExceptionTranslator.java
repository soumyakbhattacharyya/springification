...
import liquibase.rest.error.types.TitleAlreadyExistsException;
...
public class ExceptionTranslator implements ProblemHandling{
     ...
     */
    @ExceptionHandler
    public ResponseEntity<Problem> handleTitleAlreadyUsedException(TitleAlreadyExistsException ex, NativeWebRequest request
    ) {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.", "<TBD_CUSTOM_PACKAGE_NAME>");
    }
}
